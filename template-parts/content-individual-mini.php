...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	<header class="entry-header">
		...
		<?php if ( ! empty( $image ) ) : ?>
			<a href="<?php echo esc_url( get_permalink() ); ?>" rel="bookmark"><img class="avatar" src="<?php echo $image['sizes']['large']; ?>" width="<?php echo ( $image['sizes']['large-width'] / 2 ); ?>" height="<?php echo ( $image['sizes']['large-height'] / 2 ); ?>"></a>
		<?php else : ?>
			<a href="<?php echo esc_url( get_permalink() ); ?>" rel="bookmark"><img class="avatar" src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/misc/default-avatar.png" width="320" height="320" /></a>
		<?php endif; ?>
	</header><!-- .entry-header -->
