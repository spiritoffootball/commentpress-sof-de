...
// Default title.
$_all_comments_title = __( 'Recent Comments in this Document', 'commentpress-sof-de' );
 ...
 * @since 3.4
 */
$_all_comments_title = apply_filters( 'cp_activity_tab_recent_title_blog', $_all_comments_title );
		...
		<div class="sidebar_contents_wrapper">
			...
			<div class="comments_container">
				...
				if (
					...
					if ( $commentpress_core->is_groupblog() || bp_is_root_blog() ) {
