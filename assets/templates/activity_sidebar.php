 ...
 *
 * Overrides the template provided by CommentPress.
 *
 * @since 1.0.0
...
if ( $is_commentable && ! post_password_required() ) {
	...
	$_paragraph_text = sprintf(
		...
		__( 'Recent Comments on this %s', 'commentpress-sof-de' ),
		$post_type_name
	);
...
// Set default.
$_all_comments_title = __( 'Latest Comments', 'commentpress-sof-de' );
					...
					if ( $core->bp->is_groupblog() || bp_is_root_blog() ) {
						...
						if ( function_exists( 'bp_has_activities' ) && bp_has_activities( $recent_groupblog_activity ) ) :
							...
							if ( is_user_logged_in() ) {
								 ...
								 * @since 3.4.8
								 */
								$_section_header_text = apply_filters( 'cp_activity_tab_recent_title_all_yours', __( 'Recent Activity in your Documents', 'commentpress-sof-de' ) );
								 ...
								 * @since 3.4.8
								 */
								$_section_header_text = apply_filters( 'cp_activity_tab_recent_title_all_public', __( 'Recent Activity in Public Documents', 'commentpress-sof-de' ) );
